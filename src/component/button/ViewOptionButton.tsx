...
function ViewerOptionButton ({children, optionTitle, viewState, onClick}: ViewerOptionButtonParams) {
    ...
    <>
      {viewState?
          <img src={optionIcon} className="absolute w-30px h-30px top-5px right-5px rounded-xl opacity-100 bg-white cursor-pointer z-10"
               onClick={onClick} alt="" />
      ...
      {viewState?<div className="absolute w-200px h-auto top-40px right-5px border-1 border-gray-4 rounded-5px bg-white z-10">
        <p className="text-lg w-auto h-auto pt-1 pl-1 border-b-1 border-black">{optionTitle}</p>
